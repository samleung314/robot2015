 ...
 *
 */
public class AutonTwoContainerUltra extends Command {
    ...
    public AutonTwoContainerUltra(Robot robot) {
        this.robot = robot;
    }
    ...
    protected void initialize() {
		...
		ultraTravelForwardA = flippersGripB = elevatorUpB = elevatorBrakeB = 
    ...
    private void noBrake() {
		...
		case 11:
			ultraTravelForwardA = robot.ultrasonic.ultraRampAuto(Constants.canTolerance);
